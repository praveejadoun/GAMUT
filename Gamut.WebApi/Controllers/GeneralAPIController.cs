...
namespace Gamut.WebAPI.Controllers
{
    ...
    public class GeneralAPIController : ApiController
    {
        ...
        public IHttpActionResult GetGeneral(string Id)
        {
            ...
            Rating internalRating = db.Ratings.Where(i => i.ratingType == "INTERNAL" && i.Cust_Id == Id && i.ratingYear == latestInternalRatingYear).FirstOrDefault();
            ...
            Rating externalRating = db.Ratings.Where(i => i.ratingType == "EXTERNAL" && i.Cust_Id == Id && i.ratingYear == latestExternalRatingYear).FirstOrDefault();
